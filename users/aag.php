...
<?php include('include/sidebar.php');?>				
	...
	<div class="module">
							<div class="module-head">
								<h3>Applicants for Assistant Auditor General</h3>
							</div>
...
<?php $query=mysqli_query($con,"select * from applicant_details where position = 'Assistant Auditor General'");
$cnt=1;
if($query === FALSE) { 
...
?>    
										<tr>
											...
											<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost/recruitment/admin/userprofile.php?uid=<?php echo htmlentities($row['userid']);?>');" title="Update order">
