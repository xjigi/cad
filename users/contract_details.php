...
<?php 
	...
	if (isset($_GET['audit_period'])) {
		$sql =  "select * from contracts WHERE audit_period = " . $_GET['audit_period'];
		$result = mysqli_query($con, $sql);	
	}elseif (isset($_GET['audit_firm'])) {
		$sql =  "select * from contracts WHERE audit_firm = '" . str_replace('+', ' ',$_GET['audit_firm'] . "'");
		$result = mysqli_query($con,$sql);	
	}elseif (isset($_GET['organisation'])) {
		$sql =  "select * from contracts WHERE organisation = '" . str_replace('+', ' ', $_GET['organisation'] . "'");
		$result = mysqli_query($con, $sql);	
	}
	// var_dump($sql); die();
	$list = [];
